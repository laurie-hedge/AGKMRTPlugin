...
extern AGK::cImage*(*AGKCommand88)( unsigned int );
...
extern AGK::cSprite*(*AGKCommand130)( unsigned int );
...
extern AGK::cSprite*(*AGKCommand311)(  );
...
class agk
{
	public:
		...
		static inline AGK::cImage* GetImagePtr( unsigned int iImageIndex ) { return AGKCommand88( iImageIndex ); }
		...
		static inline AGK::cSprite* GetSpritePtr( unsigned int iSpriteIndex ) { return AGKCommand130( iSpriteIndex ); }
		...
		static inline AGK::cSprite* GetRayCastSprite(  ) { return AGKCommand311(  ); }
